...
def build_kd_tree(json_file_path):
    """
    Reads the JSON file in batches, processes features, and builds a KD-Tree.
    """
    combined_features = []
    photo_ids = []
    ...
    kd_tree = KDTree(combined_features)

    # Save KD-Tree and photo IDs
